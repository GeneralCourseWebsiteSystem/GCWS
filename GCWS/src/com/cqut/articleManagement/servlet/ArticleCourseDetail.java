...
/**
 * Servlet implementation class ArticleCourseDetail
 */
@WebServlet("/ArticleCourseDetail")
public class ArticleCourseDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ArticleCourseDetail() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/ArticleManagement/jsp/articleDetail.jsp").forward(request, response);
	}
