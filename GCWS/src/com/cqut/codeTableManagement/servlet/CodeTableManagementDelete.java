...
/**
 * Servlet implementation class CodeTableManagementDelete
 */
@WebServlet("/CodeTableManagementDelete")
public class CodeTableManagementDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CodeTableManagementDelete() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		codeTableImpl.deleteById(codeTableId);
